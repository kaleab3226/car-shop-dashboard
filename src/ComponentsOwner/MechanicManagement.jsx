...
const MechanicManagement = () => {
  ...
  // Moved exampleMechanics inside useEffect to avoid dependency issues
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gradient-to-r from-gray-800 to-gray-900 text-white p-8">
      ...
      <div className="max-w-6xl mx-auto bg-gray-700 p-8 rounded-lg shadow-md">
        ...
        <div>
          ...
          <div className="space-y-4">
            {mechanics.map((mechanic) => (
              <div key={mechanic.id} className="bg-gray-800 p-4 rounded-lg shadow-md flex justify-between items-center">
                <div>
                  <p>
